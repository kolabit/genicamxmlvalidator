...
namespace GenICamXmlValidator
{
    ...
    internal sealed class GenICamXmlValidator
    {
        ...
        {
            // Validator EXE file
            string strValidatorExe = "c:\\Imperx\\camera_sw\\GenICamXml\\verifier\\x64\\Release\\gc_xml_verifier.exe ";
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.package,
                validationOK ? "Gen<i>Cam valication OK": "Gen<i>Cam valication FAILED",
                "Gen<i>Cam valication",
